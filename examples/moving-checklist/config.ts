...
export class Config {
  ...
  public static tasks() {
    return [
      {questionsRequiredYes:[1],questionsRequiredNo:[],questionsAnyYes:[],questionsAnyNo:[],role:'Movee',type:'Moving Day',task:'Unscrew Lightbulbs and Pack. (Movers wont move with lightbulbs in)'},
